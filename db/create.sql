...
CREATE TABLE OrderItem (
    ...
    oid INT NOT NULL REFERENCES Order(oid),
    iid INT NOT NULL REFERENCES Inventory(iid),
...
CREATE TABLE SellerReview (
    seller_id INT NOT NULL REFERENCES User(uid),
    buyer_id INT NOT NULL REFERENCES User(uid),
    content VARCHAR(255),
